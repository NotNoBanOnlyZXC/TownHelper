...
$(document).ready(function () {   
    ...
    {
        $(footer).append('<div class="app-version"><div class="MPPL-footer-text">TownHelper: <b>' + versionPlugin +'</b></div><div class="text-nowrap d-inline d-sm-block">by <a target="_blank" href="'+ linkToAuthor +'">NoBanOnlyZXC</a></div></div>');
    }
